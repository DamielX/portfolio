  ...
  return (
    <Html lang="en">
      <Head>
        ...
        {/* PWA */}
        <meta name="application-name" content="Damiel" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="Damiel" />
        <meta name="description" content="Damiel | Front End Engineer" />
        ...
        <meta name="twitter:url" content="https://twitter.com/makpepe31" />
        <meta name="twitter:title" content="Damiel" />
        <meta name="twitter:description" content="Damiel | Front End Engineer" />
        <meta
          name="twitter:image"
        />
        <meta name="twitter:creator" content="@Damiel" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Damiel" />
        <meta property="og:description" content="Damiel | Front End Engineer" />
        <meta property="og:site_name" content="Damiel" />
        <meta property="og:url" content="https://www.Damielwenlong.com/" />
        <meta
          property="og:image"
        />
